package chapter1_4;
/******************************************************************************
 *  Compilation:  javac DoublingTestDrawing.java
 *  Execution:    java DoublingTestDrawing
 *  Dependencies: ThreeSum.java Stopwatch.java StdRandom.java StdOut.java
 *
 *  % java DoublingTestDrawing
 *      250     0.0
 *      500     0.0
 *     1000     0.1
 *     2000     0.6
...
import chapter1_1.stddraw.StdDrawDemo;
import edu.princeton.cs.algs4.*;

/**
 *  The {@code DoublingTestDrawing} class provides a client for measuring
 ...
 *  @author Kevin Wayne
 */
public class DoublingTestDrawing {
    private static final int MAXIMUM_INTEGER = 1000000;

    // This class should not be instantiated.
    private DoublingTestDrawing() {
    }
